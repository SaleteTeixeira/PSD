...
-spec encode_msg(#'Request'{} | #'Reply'{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 ->
    encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#'Request'{} | #'Reply'{}, atom() | list()) -> binary().
...
encode_msg_Request(#'Request'{type = F1, username = F2,
			      password = F3},
		   Bin, TrUserData) ->
...
dfp_read_field_def_Request(<<10, Rest/binary>>, Z1, Z2,
    ...
    d_field_Request_type(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			 TrUserData);
dfp_read_field_def_Request(<<18, Rest/binary>>, Z1, Z2,
			   F@_1, F@_2, F@_3, TrUserData) ->
    d_field_Request_username(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			     TrUserData);
dfp_read_field_def_Request(<<26, Rest/binary>>, Z1, Z2,
			   F@_1, F@_2, F@_3, TrUserData) ->
    d_field_Request_password(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			     TrUserData);
dfp_read_field_def_Request(<<>>, 0, 0, F@_1, F@_2, F@_3,
			   _) ->
    #'Request'{type = F@_1, username = F@_2,
	       password = F@_3};
...
dg_read_field_def_Request(<<0:1, X:7, Rest/binary>>, N,
    ...
    case Key of
      10 ->
	  d_field_Request_type(Rest, 0, 0, F@_1, F@_2, F@_3,
			       TrUserData);
      18 ->
	  d_field_Request_username(Rest, 0, 0, F@_1, F@_2, F@_3,
				   TrUserData);
      26 ->
	  d_field_Request_password(Rest, 0, 0, F@_1, F@_2, F@_3,
				   TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
...
d_field_Request_username(<<1:1, X:7, Rest/binary>>, N,
			 Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_Request_username(Rest, N + 7, X bsl N + Acc,
			     F@_1, F@_2, F@_3, TrUserData);
d_field_Request_username(<<0:1, X:7, Rest/binary>>, N,
...
d_field_Request_password(<<1:1, X:7, Rest/binary>>, N,
			 Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_Request_password(Rest, N + 7, X bsl N + Acc,
			     F@_1, F@_2, F@_3, TrUserData);
d_field_Request_password(<<0:1, X:7, Rest/binary>>, N,
...
merge_msg_Request(#'Request'{type = PFtype,
		  ...
		  #'Request'{type = NFtype, username = NFusername,
			     password = NFpassword},
		  _) ->
    #'Request'{type =
...
v_msg_Request(#'Request'{type = F1, username = F2,
			 password = F3},
	      Path, TrUserData) ->
    if F1 == undefined -> ok;
...
get_msg_names() -> ['Request', 'Reply'].


get_group_names() -> [].


get_msg_or_group_names() -> ['Request', 'Reply'].
